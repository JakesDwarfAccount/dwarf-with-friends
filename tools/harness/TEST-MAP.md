...
- **127** source files have at least one specific test
- **12** have none — see *Blind spots* below
- **298** tests are mapped; **3** broad sweeps run against nearly everything
...
- `node tools/harness/studio_truth_test.mjs`
- `node tools/harness/ui_lab_test.mjs`
...
| `dwf-bitmap-text.js` | `bitmap_interface_scale_test.mjs` `bitmap_text_test.mjs` `studio_canvas_budget_test.mjs` `wave4_handoff_test.mjs` |
| `dwf-build-info-panels.js` | `b114_place_candidates_test.mjs` `b229_places_depth_test.mjs` `b236_itemsheet_native_test.mjs` `b243_b244_construct_materials_test.mjs` `b254_labor_detail_test.mjs` `b279_activity_task_test.mjs` `b291_farm_placement_test.mjs` `b296_residents_parity_test.mjs` `b79_construction_menu_test.mjs` `burials_client_test.mjs` `cim_tasks_test.mjs` `color_surface_parity_test.mjs` `diplo_petitions_test.mjs` `dwfui_boot_test.mjs` `husbandry_client_test.mjs` `panel_frame_test.mjs` `siderail_flow_test.mjs` `small_ui_wavec_test.mjs` `tab_grammar_test.mjs` `ui_components_test.mjs` `uiflow_test.mjs` `v1_stale_honesty_test.mjs` `v1_stock_item_flags_test.mjs` `v1_twoclient_stale_audit.mjs` `w3_itemsheet_test.mjs` `wave4_handoff_test.mjs` `wave4_info_stocks_test.mjs` `wave4_labor_admin_test.mjs` |
| `dwf-building-zone-stockpile-panels.js` | `b151_parity_test.mjs` `b166_barracks_test.mjs` `b174_wsrebuild_client_test.mjs` `b180_b191_wirelabels_test.mjs` `b213_savetrigger_test.mjs` `b217_zoneparity2_test.mjs` `b229_places_depth_test.mjs` `b231_hauling_test.mjs` `b246_art_desc_test.mjs` `b251_archery_squads_test.mjs` `b257_b266_shop_oracles_test.mjs` `b270_chooser_overflow_test.mjs` `b276_location_temple_test.mjs` `b286_building_removal_test.mjs` `b288_b289_art_panel_test.mjs` `b55_farmplot_client_test.mjs` `building_cage_client_test.mjs` `burials_client_test.mjs` `color_surface_parity_test.mjs` `dwfui_boot_test.mjs` `lever_link_client_test.mjs` `panel_frame_test.mjs` `parity_wave1_places_workshop_test.mjs` `portrait_identity_test.mjs` `s5_location_tavern_test.mjs` `small_ui_wavec_test.mjs` `stockpile_flow_wave_test.mjs` `stockpile_repaint_session_test.mjs` `stockpile_snapshot_test.mjs` `stockpile_ui_wave_test.mjs` `ui_components_test.mjs` `uiflow_test.mjs` `uipolish2_test.mjs` `v1_stale_honesty_test.mjs` `v1_twoclient_stale_audit.mjs` `w3_itemsheet_test.mjs` `wp3a_workers_profile_test.mjs` `zone_assignability_test.mjs` `zone_delete_guard_test.mjs` `zone_repaint_session_test.mjs` |
| `dwf-burrow-overlay.js` | `b230_burrow_symbol_test.mjs` `b238_burrow_refresh_test.mjs` |
| `dwf-cache-worker.js` | `automine_tint_test.mjs` `b133_desig_range_test.mjs` `b204_black_glyphs_test.mjs` `cache_test.mjs` `f3_rebuildkey_test.mjs` `groundart_tx6_species_test.mjs` `tx4_farm_crops_test.mjs` |
| `dwf-cache.js` | `automine_tint_test.mjs` `b133_desig_range_test.mjs` `b204_black_glyphs_test.mjs` `b269_mining_indicators_test.mjs` `cache_test.mjs` `f3_rebuildkey_test.mjs` `gl_core_test.mjs` `tx4_farm_crops_test.mjs` |
| `dwf-chat.js` | `b211_wt27_clientview_test.mjs` `chat_client_test.mjs` `chat_rate_signal_test.mjs` `panel_frame_test.mjs` `panel_migration_test.mjs` `tilelist_fixture_test.mjs` `ui_components_test.mjs` `uiflow_test.mjs` `wt11_world3d_dom_test.mjs` `wt20_touch_test.mjs` |
| `dwf-chrome.js` | `dwfui_adoption_test.mjs` `studio_asset_transport_test.mjs` |
...
| `dwf-console-panel.js` | `console_panel_test.mjs` `screen_truth_browser_test.mjs` |
...
| `dwf-escmenu.js` | `b213_savetrigger_test.mjs` `friend_save_policy_test.mjs` |
| `dwf-farm-crops.js` | `tx4_farm_crops_test.mjs` |
| `dwf-fort-admin.js` | `b227_justice_ui_test.mjs` `b283_office_req_test.mjs` `cim_justice_test.mjs` `cim_nobles_test.mjs` `cim_wave5_test.mjs` `color_surface_parity_test.mjs` `diplo_petitions_test.mjs` `hostwrites_fixture_test.mjs` `v1_twoclient_stale_audit.mjs` `wave4_labor_admin_test.mjs` |
...
| `dwf-interface-shell.js` | `b245_minimap_chrome_test.mjs` `screen_truth_browser_test.mjs` |
...
| `dwf-kitchen.js` | `cim_kitchen_test.mjs` `dwfui_boot_test.mjs` `wave4_cpp_wire_test.mjs` `wave4_labor_admin_test.mjs` |
| `dwf-labor-work-orders.js` | `b284_bolt_search_test.mjs` `b285_workorder_condition_editor_test.mjs` `b285_workorder_conditions_read_test.mjs` `cim_chores_test.mjs` `cim_petitions_test.mjs` `cim_standingorders_test.mjs` `cim_wave5_test.mjs` `cim_workorders_test.mjs` `color_surface_parity_test.mjs` `panel_frame_test.mjs` `parity_wave1_work_orders_test.mjs` `uiflow_test.mjs` `v1_twoclient_stale_audit.mjs` `v1_workorder_cancel_test.mjs` `wave4_handoff_test.mjs` |
...
| `dwf-panelframe.js` | `panel_frame_test.mjs` `panel_migration_test.mjs` `siderail_paint_clip_test.mjs` `ui_components_test.mjs` `v1_shell_single_pop_test.mjs` `w3_itemsheet_test.mjs` `wave4_info_stocks_test.mjs` |
...
| `dwf-ui-components.js` | `announcement_parity_test.mjs` `audio_client_test.mjs` `b151_parity_test.mjs` `b166_barracks_test.mjs` `b174_wsrebuild_client_test.mjs` `b217_zoneparity2_test.mjs` `b227_justice_ui_test.mjs` `b228_missions_test.mjs` `b229_places_depth_test.mjs` `b230_burrow_symbol_test.mjs` `b231_hauling_test.mjs` `b232_announce_screen_test.mjs` `b233_stub_sweep_test.mjs` `b236_itemsheet_native_test.mjs` `b245_minimap_chrome_test.mjs` `b246_art_desc_test.mjs` `b250_cycler_middle_test.mjs` `b252_schedule_columns_test.mjs` `b254_labor_detail_test.mjs` `b270_chooser_overflow_test.mjs` `b276_location_temple_test.mjs` `b279_activity_task_test.mjs` `b283_office_req_test.mjs` `b285_workorder_condition_editor_test.mjs` `b285_workorder_conditions_read_test.mjs` `b286_building_removal_test.mjs` `b288_b289_art_panel_test.mjs` `b295_squad_flow_parity_test.mjs` `b296_residents_parity_test.mjs` `b55_farmplot_client_test.mjs` `b73_combat_history_test.mjs` `b88_worldmap_test.mjs` `bitmap_text_test.mjs` `charprofile_p2_test.mjs` `charprofile_structured_test.mjs` `charprofile_wording_test.mjs` `chat_client_test.mjs` `cim_chores_test.mjs` `cim_justice_test.mjs` `cim_kitchen_test.mjs` `cim_nobles_test.mjs` `cim_petitions_test.mjs` `cim_standingorders_test.mjs` `cim_workorders_test.mjs` `color_surface_parity_test.mjs` `console_panel_test.mjs` `df_color_palette_test.mjs` `digest_client_test.mjs` `diplo_petitions_test.mjs` `dwfui_adoption_test.mjs` `dwfui_boot_test.mjs` `hospital_fixture_test.mjs` `hostpanel_test.mjs` `hostwrites_fixture_test.mjs` `join_auth_test.mjs` `native_popup_test.mjs` `obligations_test.mjs` `parity_wave1_places_workshop_test.mjs` `parity_wave1_squads_test.mjs` `parity_wave1_unit_profile_test.mjs` `parity_wave1_work_orders_test.mjs` `parity_wave1_world_test.mjs` `portrait_identity_test.mjs` `portraits_test.mjs` `s5_location_tavern_test.mjs` `siderail_flow_test.mjs` `siderail_paint_clip_test.mjs` `squads_view_fixture_test.mjs` `status_truth_test.mjs` `stockpile_flow_wave_test.mjs` `stockpile_ui_wave_test.mjs` `studio_asset_transport_test.mjs` `studio_canvas_budget_test.mjs` `tab_grammar_test.mjs` `tilelist_fixture_test.mjs` `tradedepot_fixture_test.mjs` `tx14_announce_test.mjs` `ui_components_test.mjs` `ui_drift_guard_test.mjs` `v1_stock_item_flags_test.mjs` `v1_workorder_cancel_test.mjs` `vote_fixture_test.mjs` `w3_itemsheet_test.mjs` `wave4_handoff_test.mjs` `wave4_info_stocks_test.mjs` `wave4_labor_admin_test.mjs` `wave4_squads_parity_test.mjs` `wave4_unit_profile_test.mjs` `wt11_world3d_dom_test.mjs` |
| `dwf-unit-hud-notifications.js` | `announcement_parity_test.mjs` `b232_announce_screen_test.mjs` `b233_stub_sweep_test.mjs` `b270_chooser_overflow_test.mjs` `b279_activity_task_test.mjs` `b73_combat_history_test.mjs` `charprofile_p2_test.mjs` `charprofile_portraits_test.mjs` `charprofile_structured_test.mjs` `charprofile_wording_test.mjs` `color_surface_parity_test.mjs` `combatlog_fixture_test.mjs` `df_color_palette_test.mjs` `followcam_unit_persist_test.mjs` `notification_wave_test.mjs` `panel_frame_test.mjs` `parity_wave1_unit_profile_test.mjs` `pause_anim_test.mjs` `portrait_identity_test.mjs` `portrait_native_fault_guard_test.mjs` `portraits_test.mjs` `siderail_paint_clip_test.mjs` `small_ui_wavec_test.mjs` `status_truth_test.mjs` `tab_grammar_test.mjs` `tx14_announce_test.mjs` `uiflow_test.mjs` `uipolish2_test.mjs` `unitsheet_live_test.mjs` `v1_twoclient_stale_audit.mjs` `w3_itemsheet_test.mjs` `wave4_handoff_test.mjs` `wave4_unit_profile_test.mjs` |
...
| `dwf-wire-v1.js` | `automine_tint_test.mjs` `b204_black_glyphs_test.mjs` `cache_test.mjs` `flows_miasma_test.mjs` `gen_wire_fixture.mjs` `groundart_tx6_species_test.mjs` `protocol_v1_registry_test.mjs` `tx1_barrel_peek_test.mjs` `tx4_farm_crops_test.mjs` `wc17_wc18_test.mjs` `wire_decode_test.mjs` |
| `dwf-world3d-model.js` | `wt11_camera_test.mjs` `wt11_world3d_dom_test.mjs` |
| `dwf-world3d.js` | `wt11_world3d_dom_test.mjs` |
| `dwf-worldmap.js` | `b228_missions_test.mjs` `b88_worldmap_test.mjs` `parity_wave1_world_test.mjs` |
| `dwf-write-guards.js` | `b295_squad_flow_parity_test.mjs` `v1_safety_gate_test.mjs` `zone_delete_guard_test.mjs` |
| `dwf-ws.js` | `autosave_interval_aux_test.mjs` `b238_burrow_refresh_test.mjs` `b263_zoomflash_test.mjs` `chat_rate_signal_test.mjs` `diplo_petitions_test.mjs` `dropstale_test.mjs` `native_popup_test.mjs` `v1_twoclient_stale_audit.mjs` `vote_fixture_test.mjs` `wa5_conditional_test.mjs` |
...
| `building_zone.cpp` | `b166_barracks_test.mjs` `b213_savetrigger_test.mjs` `b221_workshopstall_cache_test.mjs` `b229_places_depth_test.mjs` `b246_art_desc_test.mjs` `b251_archery_squads_test.mjs` `b270_chooser_overflow_test.mjs` `b276_location_temple_test.mjs` `b55_farmplot_client_test.mjs` `build_place_invariant_test.mjs` `husbandry_client_test.mjs` `s5_location_tavern_test.mjs` `small_ui_wavec_test.mjs` `ui_cache_purge_guard_test.mjs` `uiflow_test.mjs` `uipolish2_test.mjs` `v1_safety_gate_test.mjs` `zone_assignability_test.mjs` `zone_delete_guard_test.mjs` `zone_repaint_safety_test.mjs` `zone_repaint_status_test.mjs` |
| `burrows_panel.cpp` | `b230_burrow_symbol_test.mjs` `b238_burrow_refresh_test.mjs` `burrows_api_result_test.mjs` `color_surface_parity_test.mjs` |
| `chat.cpp` | _none_ |
...
| `diagnostics.cpp` | `diagnostics_log_bound_test.mjs` `wt24_crashdiag_test.mjs` |
| `diplo.cpp` | `diplo_petitions_test.mjs` |
| `dwf.cpp` | `json_mini_vectors_test.mjs` `portrait_native_fault_guard_test.mjs` `portrait_sweep_test.mjs` `save_barrier_test.mjs` `stockpile_repair_wiring_test.mjs` `world_reload_reset_test.mjs` `wt24_crashdiag_test.mjs` |
| `flight_recorder.cpp` | `flight_recorder_contract_test.mjs` |
| `flight_recorder_v3.cpp` | `flight_recorder_contract_test.mjs` |
| `fort_admin.cpp` | `b180_b191_wirelabels_test.mjs` `b233_stub_sweep_test.mjs` `b283_office_req_test.mjs` `b290_child_assignment_guards_test.mjs` `b293_noble_squad_availability_test.mjs` `cim_wave5_test.mjs` `diplo_petitions_test.mjs` `hostwrites_fixture_test.mjs` `rostertruth_classification_test.mjs` `v1_safety_gate_test.mjs` `v1_squad_asneeded_gates_test.mjs` `wave4_labor_admin_test.mjs` |
...
| `http_server.cpp` | `b238_burrow_refresh_test.mjs` `b256_projectile_sprite_test.mjs` `b269_mining_indicators_test.mjs` `b69_surface_recenter_test.mjs` `bitmap_text_test.mjs` `camera_identity_transport_test.mjs` `console_route_gate_test.mjs` `diagnostic_route_gate_test.mjs` `diplo_petitions_test.mjs` `flight_recorder_contract_test.mjs` `friend_save_policy_test.mjs` `glyph_font_test.mjs` `join_public_allowlist_test.mjs` `lifecycle_guard_test.mjs` `lua_bridge_signature_test.mjs` `native_popup_test.mjs` `presence_drag_broadcast_test.mjs` `save_barrier_test.mjs` `sprites_img_cache_test.mjs` `uipolish2_test.mjs` `v1_safety_gate_test.mjs` `v1_twoclient_stale_audit.mjs` `vote_fixture_test.mjs` `wc14_tree_test.mjs` `ws_drop_counters_test.mjs` `wt24_crashdiag_test.mjs` |
...
| `interaction.cpp` | `b123_growth_item_name_test.mjs` `b170_flow_hover_test.mjs` `b213_savetrigger_test.mjs` `b236_itemsheet_native_test.mjs` `b246_art_desc_test.mjs` `b267_b268_slopes_test.mjs` `b288_b289_art_panel_test.mjs` `exact_tile_first_fixture_test.mjs` `friend_save_policy_test.mjs` `ghost_clickable_fixture_test.mjs` `siderail_flow_test.mjs` `small_ui_wavec_test.mjs` `w3_itemsheet_test.mjs` `wave4_info_stocks_test.mjs` |
| `json_mini.cpp` | `json_mini_vectors_test.mjs` |
| `json_util.cpp` | `camera_identity_transport_test.mjs` |
| `kitchen_panel.cpp` | `cim_kitchen_test.mjs` `kitchen_api_result_test.mjs` `small_ui_wavec_test.mjs` `wave4_cpp_wire_test.mjs` |
| `labor.cpp` | `b254_labor_detail_test.mjs` `labor_api_result_test.mjs` `unitlist_classification_test.mjs` |
| `lever_link.cpp` | _none_ |
| `lua_bridge.cpp` | `b114_place_candidates_test.mjs` `b229_places_depth_test.mjs` `b276_location_temple_test.mjs` `b285_workorder_condition_editor_test.mjs` `build_place_invariant_test.mjs` `console_route_gate_test.mjs` `lua_bridge_signature_test.mjs` `lua_generated_source_test.mjs` `save_barrier_test.mjs` `stockpile_repaint_session_test.mjs` `stockpile_repair_wiring_test.mjs` `stockpile_settings_guard_test.mjs` `stockpile_snapshot_test.mjs` |
...
| `oracle_routes.cpp` | `tiledump_bounds_test.mjs` |
...
| `portrait_sweep.cpp` | `portrait_native_fault_guard_test.mjs` `portrait_sweep_test.mjs` |
| `request_origin.cpp` | `request_origin_test.mjs` |
| `save_barrier.cpp` | `save_barrier_test.mjs` |
| `sdl_capture.cpp` | `bake_sweep_test.mjs` |
| `session_routes.cpp` | `b213_savetrigger_test.mjs` `camera_identity_transport_test.mjs` `console_route_gate_test.mjs` `friend_save_policy_test.mjs` `join_version_test.mjs` `request_origin_test.mjs` `v1_twoclient_stale_audit.mjs` `view_stamp_test.mjs` |
| `sound_route.cpp` | _none_ |
| `sprite_map.cpp` | `b241_groundrender_test.mjs` |
| `squads.cpp` | `b233_stub_sweep_test.mjs` `b252_schedule_columns_test.mjs` `b290_child_assignment_guards_test.mjs` `b293_noble_squad_availability_test.mjs` `b295_squad_flow_parity_test.mjs` `milequip_wire_test.mjs` `rostertruth_classification_test.mjs` `squad_delete_teardown_test.mjs` `squads_view_fixture_test.mjs` `v1_safety_gate_test.mjs` `v1_squad_asneeded_gates_test.mjs` `wave4_squads_parity_test.mjs` `zone_delete_guard_test.mjs` |
...
| `stockpile_panel.cpp` | `stockpile_flow_wave_test.mjs` `stockpile_repaint_session_test.mjs` `stockpile_settings_guard_test.mjs` `stockpile_snapshot_test.mjs` `ui_cache_purge_guard_test.mjs` |
| `stone_use.cpp` | `stone_use_api_result_test.mjs` |
...
| `unit_portrait.cpp` | `b246_art_desc_test.mjs` `portrait_native_fault_guard_test.mjs` `portrait_sweep_test.mjs` |
...
| `websocket.cpp` | `camera_identity_transport_test.mjs` `chat_client_test.mjs` `chat_rate_signal_test.mjs` `json_mini_vectors_test.mjs` `lifecycle_guard_test.mjs` `lobby_rename_test.mjs` `reqblocks_queue_bounds_test.mjs` `request_origin_test.mjs` `s3_s4_s5_staging_test.mjs` `ws_drop_counters_test.mjs` `ws_upgrade_header_capacity_test.mjs` `wt24_crashdiag_test.mjs` |
| `wire_v1.cpp` | `automine_tint_test.mjs` `b204_black_glyphs_test.mjs` `b269_mining_indicators_test.mjs` `b47_construction_floor_test.mjs` `b90_plant_identity_test.mjs` `cache_test.mjs` `flows_miasma_test.mjs` `gen_wire_fixture.mjs` `grass_under_pebbles_test.mjs` `groundart_b37_test.mjs` `groundart_tx6_species_test.mjs` `treegrass_ghost_tint_test.mjs` `tx4_farm_crops_test.mjs` `wb11_sparse_test.mjs` `window11_meatfish_test.mjs` `window12_corpse_test.mjs` `wire_decode_test.mjs` `wire_tail_bounds_test.mjs` |
| `work_orders.cpp` | `b285_workorder_condition_editor_test.mjs` `lua_bridge_signature_test.mjs` |
| `world_stream.cpp` | `automine_tint_test.mjs` `autosave_interval_aux_test.mjs` `b108_claimed_designation_blink_test.mjs` `b122_b124_gather_job_validation_test.mjs` `b204_black_glyphs_test.mjs` `b222_status_serializer_parity_test.mjs` `b253_statue_test.mjs` `b256_projectile_sprite_test.mjs` `b263_zoomflash_test.mjs` `b273_material_tint_test.mjs` `b278_late_unit_sprite_test.mjs` `b35_djobs_test.mjs` `b54_claimed_wall_designation_test.mjs` `b63_workshop_test.mjs` `flows_miasma_test.mjs` `lifecycle_guard_test.mjs` `portrait_sweep_test.mjs` `reqblocks_queue_bounds_test.mjs` `s1_s2_scheduler_test.mjs` `s3_s4_s5_staging_test.mjs` `sb_transport_test.mjs` `tx17_planned_construction_test.mjs` `tx4_farm_crops_test.mjs` `unit_visibility_filter_test.mjs` `unitlist_classification_test.mjs` `waveb_designation_test.mjs` `wcclient_matrix_test.mjs` `world_reload_reset_test.mjs` `wt02_wt05_roster_oracle.mjs` `wt29_mood_subtype_test.mjs` `wt30_status_full_test.mjs` |
