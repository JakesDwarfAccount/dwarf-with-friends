...
-- In-game control panel for the dwf browser stream server. It builds the connect
...
DfCapture.ATTRS{
    frame_title = 'Dwf - browser multiplayer',
    frame = {w=68, h=17},
}
    ...
    self:addviews{
        ...
        widgets.Label{
            ...
            text = {
                ...
                {text='keybinding add Ctrl-Shift-W gui/dwf', pen=COLOR_LIGHTCYAN},
            },
        },
    }
    self:refresh()
...
DfCaptureScreen.ATTRS{focus_path = 'dwf'}
