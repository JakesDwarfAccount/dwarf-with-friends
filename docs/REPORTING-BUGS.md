...
fastest way to get something fixed: clear steps help us investigate.

## Before you report

**Hard-refresh first: press Ctrl+Shift+R in the game tab.** This clears cached files and fixes
most one-off weirdness (blank map, stale UI, mystery lag). If the problem returns, include that detail in your report. More quick fixes live in [TROUBLESHOOTING.md](../TROUBLESHOOTING.md).
...
Include your Dwarf Fortress, DFHack, and Dwarf With Friends versions, plus the host operating system.
